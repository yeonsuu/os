...
struct process
{
	...
	struct list load_file_table;			/* Manage exec file of this process */
	struct list mapping_list;		/* Manage mmap memory */
	void * stack_end;				/* Point end of stack */
	void * stack_start;				/* Point end of stack */
